...
function useAutoAnimate(options2) {
  ...
  const memoizedOptions = (0, import_react.useMemo)(() => options2, []);
  ...
  const setEnabled = (0, import_react.useCallback)((enabled2) => {
    if (controller) {
...
//# sourceMappingURL=@formkit_auto-animate_react.js.map
